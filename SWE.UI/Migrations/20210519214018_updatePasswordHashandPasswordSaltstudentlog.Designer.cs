...
namespace SWE.UI.Migrations
{
    ...
    [Migration("20210519214018_updatePasswordHashandPasswordSaltstudentlog")]
    partial class updatePasswordHashandPasswordSaltstudentlog
    {
            ...
            modelBuilder.Entity("SWE.UI.Models.Domain.StudentLog", b =>
                {
                    ...
                    b.HasOne("SWE.UI.Models.Domain.Student", "Student")
                        .WithOne("StudentLog")
                        .HasForeignKey("SWE.UI.Models.Domain.StudentLog", "StudentId");
